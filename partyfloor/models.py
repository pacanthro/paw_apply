...
class PartyHost(models.Model):
    ...
    twitter_handle = models.CharField('Twitter/BSky Handle', max_length=30, null=True)
    telegram_handle = models.CharField(max_length=30, null=True)
    rbs_certification = models.CharField('RBS Certification', max_length=50, null=True)
    ...
    party_name = models.CharField(help_text='The name of your party for our website.', max_length=100, null=True)
    party_description = models.TextField(help_text='A description of your party for our website.', null=True)
    ...
    ack_amplified_sound = models.BooleanField('Amplified sound is not allowed on the balcony (inside rooms at reasonable levels is acceptable).', default=False)
