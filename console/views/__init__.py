...
from .competitors import CompetitorUpdateContentPageView
...
from .merchants import MerchantActionDeleteRedirect, MerchantActionAssignPageView, MerchantActionAcceptedRedirect, MerchantUpdateContentPageView
