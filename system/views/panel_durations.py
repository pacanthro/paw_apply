...
class PanelDurationListView(PageView):
...
class PanelDurationEditView(PageView):
...
class PanelDurationCreateView(PageView):
...
class PanelDurationDeleteRedirectView(RedirectView):
    permanent = False
